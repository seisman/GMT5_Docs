...
latex_documents = [
  (master_doc, 'GMT5_Docs.tex', 'GMT5参考手册',
   'SeisMan', 'manual'),
]
...
intersphinx_mapping = {'gmt': ('http://gmt.soest.hawaii.edu/doc/latest/', 'gmt.inv')}
